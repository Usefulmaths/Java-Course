...
public class DataTypes {
	public static void main(String[] args){
		...
		System.out.println("byteSq: " + byteVar*byteVar);
		 ...
		 //When the variable i hasn't been initialised, Eclipse prompts to give it an initial value.
		 //We are unable to obtain an updated j by adding an integer 1. (i is null)
		 /**int j=1; int i;
		 j = i + 1;**/
		 
		 //When we cast a double as an integer, the resulting integer variable drops the digits
